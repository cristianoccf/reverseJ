...
public class FileDiagramInPackage {
	...
	public void save() {
		...
		URI outputURI = URI.createFileURI(PROJECT_PATH +File.pathSeparator+ FOLDER+File.pathSeparator+ fileName)
